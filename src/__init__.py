"""
FEP-MCM Cognitive Security Architecture
======================================

Professional AI safety system with real-time threat detection.

Main Components:
- CalibratedSecuritySystem: Complete security pipeline
- EnhancedFEPMCMSystem: Advanced security layers  
- FEPCognitiveArchitecture: Base FEP implementation
...
__version__ = "1.0.0"
__author__ = "FEP-MCM Research Team"
__email__ = "research@fep-mcm.ai"
...
__all__ = [
    "CalibratedSecuritySystem",
    "EnhancedFEPMCMSystem"
]